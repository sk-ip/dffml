...
input_data = Definition(name="input_data", primitive="List[List[int]]")
output_data = Definition(name="output_data", primitive="List[List[int]]")
n_components = Definition(name="n_components", primitive="int")
n_iter = Definition(name="n_iter", primitive="int")
random_state = Definition(name="random_state", primitive="int")
missing_values = Definition(name="missing_values", primitive="Any")
strategy = Definition(name="strategy", primitive="str")
categories = Definition(name="categories", primitive="List[List[Any]]")
...
async def principal_componenet_analysis(
