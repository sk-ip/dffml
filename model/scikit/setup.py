...
setup(
    ...
    entry_points={
        ...
        "dffml.accuracy": [
            ...
            f"bacscore = {IMPORT_NAME}.scikit_scorers:BalancedAccuracyScore",
            f"topkscore = {IMPORT_NAME}.scikit_scorers:TopKAccuracyScore",
            f"avgprescore = {IMPORT_NAME}.scikit_scorers:AveragePrecisionScore",
            f"brierscore = {IMPORT_NAME}.scikit_scorers:BrierScoreLoss",
            f"f1score = {IMPORT_NAME}.scikit_scorers:F1Score",
            f"logloss = {IMPORT_NAME}.scikit_scorers:LogLoss",
            f"prescore = {IMPORT_NAME}.scikit_scorers:PrecisionScore",
            f"recallscore = {IMPORT_NAME}.scikit_scorers:RecallScore",
            f"Jacscore = {IMPORT_NAME}.scikit_scorers:JaccardScore",
            f"rocaucscore = {IMPORT_NAME}.scikit_scorers:RocAucScore",
            f"adjmutinfoscore = {IMPORT_NAME}.scikit_scorers:AdjustedMutualInfoScore",
            f"adjrandscore = {IMPORT_NAME}.scikit_scorers:AdjustedRandScore",
            f"complscore = {IMPORT_NAME}.scikit_scorers:CompletenessScore",
            f"fowlmalscore = {IMPORT_NAME}.scikit_scorers:FowlkesMallowsScore",
            f"homoscore = {IMPORT_NAME}.scikit_scorers:HomogeneityScore",
            f"mutinfoscore = {IMPORT_NAME}.scikit_scorers:MutualInfoScore",
            f"normmutinfoscore = {IMPORT_NAME}.scikit_scorers:NormalizedMutualInfoScore",
            f"randscore = {IMPORT_NAME}.scikit_scorers:RandScore",
            f"vmscore = {IMPORT_NAME}.scikit_scorers:VMeasureScore",
            f"exvscore = {IMPORT_NAME}.scikit_scorers:ExplainedVarianceScore",
            f"maxerr = {IMPORT_NAME}.scikit_scorers:MaxError",
            f"meanabserr = {IMPORT_NAME}.scikit_scorers:MeanAbsoluteError",
            f"meansqrerr = {IMPORT_NAME}.scikit_scorers:MeanSquaredError",
            f"meansqrlogerr = {IMPORT_NAME}.scikit_scorers:MeanSquaredLogError",
            f"medabserr = {IMPORT_NAME}.scikit_scorers:MedianAbsoluteError",
            f"r2score = {IMPORT_NAME}.scikit_scorers:R2Score",
            f"meanpoidev = {IMPORT_NAME}.scikit_scorers:MeanPoissonDeviance",
            f"meangammadev = {IMPORT_NAME}.scikit_scorers:MeanGammaDeviance",
            f"meanabspererr = {IMPORT_NAME}.scikit_scorers:MeanAbsolutePercentageError",
        ],
    },
)
